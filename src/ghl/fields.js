...
export const TICKET_FIELDS = [
  ...
  { key: 'support_steps_taken',     name: 'Steps Already Taken (L1)', dataType: 'LARGE_TEXT' },
  { key: 'support_impact',          name: 'Customer Impact',          dataType: 'LARGE_TEXT' },
  { key: 'support_escalated_by',    name: 'Escalated By',             dataType: 'TEXT' },
